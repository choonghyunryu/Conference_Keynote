...
.center[
  <img src="fig/survey2.png" alt="2011년 R User Conference 설문 요약" width="70%">
]
...
.center[
  <img src="fig/r-paradigm.png" alt="R 생태계의 패러다임 전환" width="70%">
]
...
* 데이터 과학자를 위한 충분조건
* 재현가능 연구를 위한 생태계 완비
  + 데이터 분석 경험의 공유 및 핸즈온 교육 강화
* 엔터프라이즈 시장에서의 활용 가능
  + 부족했던 성능의 캐치업 &#8594; 수행속도, 핸들링 용량 등
